...
#
TestingWithRealData - responsible for real data analysis. Warning: DLPFC and Slide-seq are very large dataset which require long computation time. Utilized functions nngp_approx, SpatialPCA_EstimateLoading_NNGP, and SpatialPCA_SpatialPCs_NNGP.
